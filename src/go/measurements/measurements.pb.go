...
type Coordinate2D_Error struct {
	Latitude             *units.Degrees               `protobuf:"bytes,1,opt,name=latitude,proto3" json:"latitude,omitempty"`
	Longitude            *units.Degrees               `protobuf:"bytes,2,opt,name=longitude,proto3" json:"longitude,omitempty"`
	Hdop                 *measurements.DOP_Horizontal `protobuf:"bytes,3,opt,name=hdop,proto3" json:"hdop,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (m *Coordinate2D_Error) GetHdop() *measurements.DOP_Horizontal {
	if m != nil {
		return m.Hdop
	}
	return nil
...
type Altitude_Error struct {
	Height               *units.Meters              `protobuf:"bytes,1,opt,name=height,proto3" json:"height,omitempty"`
	Vdop                 *measurements.DOP_Vertical `protobuf:"bytes,2,opt,name=vdop,proto3" json:"vdop,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *Altitude_Error) GetVdop() *measurements.DOP_Vertical {
	if m != nil {
		return m.Vdop
	}
	return nil
